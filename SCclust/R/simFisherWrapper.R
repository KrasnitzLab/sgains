...
#' \code{findpins}),
#'compute the Fisher's test p-values for pairwise comparisons. Also perform 
#' permutations on the incidence table and
#'compute a set of Fisher's test p-values for each permutation.
#'@param pins The pin generated by \code{findpins}. The bin information 
#' for the selected feature set.
#'@param pinmat The incidence table generated by \code{findpins}.
#'@param sim_round An integer. The number of permutations/simulations. 
#' Default value: 500.
#'@return A list of two numeric vector objects. The Fisher's test p-values 
#' for the observation (true_fisherPV) and for
...
simFisher_parallel <- function(pins, pinmat, sim_round = 500){
  ...
  true_fisherPV <- simFisher(m, nsim = 1, nsweep = 0, seedme = 123,
                             distrib = "Rparallel", njobs = usecores, 
							 combo = "Fisher")
